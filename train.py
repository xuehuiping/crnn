...
# 指定训练集根目录
parser.add_argument('--trainroot', default='./data/Challenge2_Training_Task3_Images_GT/', help='训练集路径')
# 指定验证集根目录
parser.add_argument('--valroot', default='./data/Challenge2_Training_Task3_Images_GT/', help='验证集路径')
...
test_dataset = dataset.RawDataset(
    gt_file=os.path.join(opt.trainroot, 'gt.txt'), gt_dir=opt.trainroot,
